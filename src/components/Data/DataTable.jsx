          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-neutral-700">
              <tr>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200">{data.coordinates}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">{data?.district || data?.division}</td>
